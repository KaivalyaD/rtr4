...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Rangoli: Kaivalya Vishwakumar Deshpande"),
...
void resize(int width, int height)
{
	...
	glMatrixMode(GL_PROJECTION); // select current operating matrix as the projection matrix
	glLoadIdentity();	// load identity matrix into current matrix
...
void display(void)
{
	...
	void drawBaseTriangle(void);
	void drawBaseSquare(void);
	void drawBaseTriangleWithinSquare(void);
	void drawBaseTriangleFan(void);
	void drawBaseSquareColored(void);
