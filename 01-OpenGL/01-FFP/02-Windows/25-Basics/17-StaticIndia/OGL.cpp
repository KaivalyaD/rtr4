...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Static India: Kaivalya Deshpande"),
...
void drawLetterD(void)
{
	...
	glBegin(GL_QUADS);
	{
		...
		glVertex3f(xpos + xlimit / 2.0f, ypos, 0.0f);

		glColor3f(1.0f, 0.8f, 0.6f);
		glVertex3f(xpos + xlimit, ypos - ylimit / 4.0f - 0.025f, 0.0f);
		glVertex3f(xpos + xlimit, ypos - ylimit / 4.0f, 0.0f);

		// second vertical
		glVertex3f(xpos + xlimit, ypos - ylimit / 4.0f, 0.0f);
		glVertex3f(xpos + xlimit - 0.0125f, ypos - ylimit / 4.0f, 0.0f);

		glColor3f(1.0f, 1.0f, 1.0f);
		glVertex3f(xpos + xlimit - 0.0125f, ypos - (3.0f * ylimit / 10.0f) / 1.6f - 0.125f, 0.0f);
		glVertex3f(xpos + xlimit, ypos - (3.0f * ylimit / 4.0f) / 1.6f - 0.0125f, 0.0f);
		glVertex3f(xpos + xlimit, ypos - (3.0f * ylimit / 4.0f) / 1.6f - 0.0125f, 0.0f);
		glVertex3f(xpos + xlimit - 0.0125f, ypos - (3.0f * ylimit / 4.0f) / 1.6f - 0.0125f, 0.0f);

		glColor3f(0.74f, 0.834f, 0.633f);
		glVertex3f(xpos + xlimit - 0.0125f, ypos - (3.0f * ylimit / 4.0f) - 0.0125f, 0.0f);
		...
		glColor3f(0.074f, 0.534f, 0.0313f);
		glVertex3f(xpos + xlimit / 2.0f, ypos - ylimit, 0.0f);
