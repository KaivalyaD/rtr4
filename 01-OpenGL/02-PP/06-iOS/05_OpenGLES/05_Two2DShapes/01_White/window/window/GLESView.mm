...
-(void) renderScene
{
    ...
    glUseProgram(shaderProgramObject);
    {
        ...
        vmath::mat4 modelViewProjectionMatrix = perspectiveProjectionMatrix * vmath::translate(-1.5f, 0.0f, -6.0f);
        ...
        modelViewProjectionMatrix = perspectiveProjectionMatrix * vmath::translate(1.5f, 0.0f, -6.0f);
        glUniformMatrix4fv(mvpMatrixUniform, 1, GL_FALSE, modelViewProjectionMatrix);
