...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		case 'F':
		case 'f':
			/* if the light is on, switch to per-fragment lighting */
			if (bLight && bPerVertexLight)
		...
		case 'V':
		case 'v':
			/* if the light is on, switch to per-vertex lighting */
			if (bLight && !bPerVertexLight)
...
int initialize(void)
{
	...
	pv_laUniform = glGetUniformLocation(pv_shaderProgramObject, "u_La");
	pv_ldUniform = glGetUniformLocation(pv_shaderProgramObject, "u_Ld");
	pv_lsUniform = glGetUniformLocation(pv_shaderProgramObject, "u_Ls");
	pv_lightPositionUniform = glGetUniformLocation(pv_shaderProgramObject, "u_lightPosition");
	...
	pf_laUniform = glGetUniformLocation(pf_shaderProgramObject, "u_La");
	pf_ldUniform = glGetUniformLocation(pf_shaderProgramObject, "u_Ld");
	pf_lsUniform = glGetUniformLocation(pf_shaderProgramObject, "u_Ls");
	pf_lightPositionUniform = glGetUniformLocation(pf_shaderProgramObject, "u_lightPosition");
