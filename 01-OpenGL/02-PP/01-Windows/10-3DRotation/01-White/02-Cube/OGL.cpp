...
void display(void)
{
	...
	glUseProgram(shaderProgramObject);
	{
		...
		rotationMatrix_X = vmath::rotate(angleY, 1.0f, 0.0f, 0.0f);
		rotationMatrix_Y = vmath::rotate(angleY, 0.0f, 1.0f, 0.0f);
		rotationMatrix_Z = vmath::rotate(angleY, 0.0f, 0.0f, 1.0f);
