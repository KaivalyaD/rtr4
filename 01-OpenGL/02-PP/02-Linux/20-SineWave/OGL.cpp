...
{
    // function prototypes
    void animateSineWave(unsigned int, unsigned int, float);
    ...
    {
        // update vertex positions' source
        animateSineWave(meshWidth, meshHeight, animTime);
...
void animateSineWave(unsigned int width, unsigned int height, float phase)
{
    // local variables
    float u, v;
    float freq = 4.0f;
