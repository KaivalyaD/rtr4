...
int initialize(void)
{
	...
	const GLchar *vertexShaderSourceCode =
        ...
        "{\n" \
            ...
            "{\n" \
                ...
                "\n" \
                "diffuseLightColor = ub_light.Ld * ub_material.Kd * max(dot(lightDirection, transformedNormal), 0.0);\n" \
            "}\n" \
            "\n" \
	...
	const GLchar *fragmentShaderSourceCode =
        ...
        "{\n" \
            "if (u_lightEnabled == 1)\n" \
                "FragColor = vec4(diffuseLightColor, 1.0);\n" \
            "else\n" \
    ...
    glBindVertexArray(vaoCube);
    {
        ...
        // normals
        glGenBuffers(1, &vboCubeNormals);
        glBindBuffer(GL_ARRAY_BUFFER, vboCubeNormals);
        {
            // vertex normals
...
void uninitialize(void)
{
    ...
    if(vboCubeNormals)
    {
        glDeleteBuffers(1, &vboCubeNormals);
        vboCubeNormals = 0U;
    }
