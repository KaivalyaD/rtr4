    ...
    glUseProgram(shaderProgramObject);
    {
        ...
        push(modelViewMatrix, stackMatModelView);
        {
            ...
            push(modelViewMatrix, stackMatModelView);
            {
                ...
                pop(stackMatModelView);  // pop transformations for the earth
                ...
                pop(stackMatModelView);  // pop transformations for the moon
            }
            pop(stackMatModelView);  // pop transformations for the sun
        }
        pop(stackMatModelView);  // pop identity
    }
    glUseProgram(0);
