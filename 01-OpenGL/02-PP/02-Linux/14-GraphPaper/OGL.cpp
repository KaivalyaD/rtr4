...
int initialize(void)
{
    ...
    glBindVertexArray(vaoCircle);
    {
        ...
        {
            // data
            vmath::vec3 vertexPositions[100];
...
void render(void)
{
    ...
    vmath::mat4 viewProjectionMatrix = vmath::mat4::identity();
    ...
    glUseProgram(shaderProgramObject);
    {
        if (gbShowGrid)
        {
            ...
            for (int i = 0; i < 41; i++)
            {
                if (i != 20)
                {
                    ...
                    glVertexAttrib4f(KVD_ATTRIBUTE_COLOR, 0.0f, 0.0f, 1.0f, 1.0f);
            ...
            glUniformMatrix4fv(mvpMatrixUniform, 1, GL_FALSE, mvpMatrix);
            glVertexAttrib4f(KVD_ATTRIBUTE_COLOR, 1.0f, 0.0f, 1.0f, 1.0f);
            ...
            glUniformMatrix4fv(mvpMatrixUniform, 1, GL_FALSE, mvpMatrix);
            glVertexAttrib4f(KVD_ATTRIBUTE_COLOR, 0.0f, 1.0f, 0.0f, 1.0f);
        ...
        if (gbShowTriangle)
        {
            glVertexAttrib4f(KVD_ATTRIBUTE_COLOR, 1.0f, 1.0f, 0.0f, 1.0f);
        ...
        if (gbShowSquare)
        {
            glVertexAttrib4f(KVD_ATTRIBUTE_COLOR, 0.8f, 0.3f, 0.0f, 1.0f);
