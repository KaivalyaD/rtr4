...
public class GLESView extends GLSurfaceView implements OnDoubleTapListener, OnGestureListener, GLSurfaceView.Renderer {
    ...
    private void initialize() {
        ...
        light[2].setAmbientColorUniformLocation(GLES32.glGetUniformLocation(shaderProgramObject, "u_La[2]"));
        light[2].setDiffuseColorUniformLocation(GLES32.glGetUniformLocation(shaderProgramObject, "u_Ld[2]"));
        light[2].setSpecularColorUniformLocation(GLES32.glGetUniformLocation(shaderProgramObject, "u_Ls[2]"));
        light[2].setPositionUniformLocation(GLES32.glGetUniformLocation(shaderProgramObject, "u_lightPosition[2]"));
        light[2].setSwitchUniformLocation(GLES32.glGetUniformLocation(shaderProgramObject, "u_lightEnabled"));
