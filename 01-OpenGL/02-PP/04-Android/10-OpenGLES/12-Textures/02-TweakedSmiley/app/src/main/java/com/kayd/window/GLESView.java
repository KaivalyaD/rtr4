...
public class GLESView extends GLSurfaceView implements OnDoubleTapListener, OnGestureListener, GLSurfaceView.Renderer {
    ...
    private ByteBuffer byteBuffer;  // to store texture image data
    private int texState;
    ...
    private void initialize() {
        ...
        GLES32.glBindVertexArray(vao[0]);
        {
            ...
            {
                // allocate space for 4 floating point tex coords in byteBuffer
    ...
    private void render() {
        ...
        GLES32.glUseProgram(shaderProgramObject);
        {
            ...
            vertexTexCoordsBuffer.put(texCoords);
            ...
            GLES32.glBindVertexArray(vao[0]);
            {
                ...
                GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, textureSmiley[0]);
                    ...
                    GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, vboTexCoords[0]);
                        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, 4 * 2 * 4, vertexTexCoordsBuffer, GLES32.GL_DYNAMIC_DRAW);
                    GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
