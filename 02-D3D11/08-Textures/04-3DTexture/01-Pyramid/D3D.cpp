...
HRESULT initialize(void)
{
	...
	// create texture
	hr = LoadD3DTexture(L"./resources/Stone.bmp", &gpID3D11ShaderResourceView_Texture);
	if (FAILED(hr))
	{
		fopen_s(&gpLog, "Log.txt", "a+");
...
void display(void)
{
	...
	// transformations
	XMMATRIX worldMatrix = XMMatrixRotationY(XMConvertToRadians(theta)) * XMMatrixTranslation(0.0f, 0.0f, 5.0f);
